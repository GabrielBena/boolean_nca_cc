...
def get_n4_chain_circuit_spec(arity=2):
    ...
    wires_chain = [jp.array([[0], [1]]), jp.array([[2], [4]]), jp.array([[3], [5]])]
...
def get_n4_balanced_circuit_spec(arity=2):
    ...
    logits_balanced = [jp.array(initial_logits_g0g1), jp.array(initial_logits_g2)]
    wires_balanced = [jp.array([[0, 2], [1, 3]]), jp.array([[4], [5]])]
