...
Barebones trajectory plot with two side-by-side panels:
- hard_accuracy vs message steps, with optional error bands from hard_accuracy_std
- loss vs message steps (prefers hard_loss, falls back to soft_loss)
...
def plot_stepwise_trajectory(
    ...
    ax_acc.set_yticks(np.arange(0.6, 1.03, 0.05))
    ax_acc.set_ylim(0.65, 1.03)
...
def main() -> None:
    ...
    if output_path is None:
        output_path = f"reports/figures/stepwise_{args.run_id}.png"
